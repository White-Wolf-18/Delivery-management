    ...
    <div className="container">
      ...
      <div className="login-card">
        ...
        <div className="toggle-container">
          ...
          <span className={userType === "Staff" ? "active" : ""}>Staff</span>
        </div>

        {/* Login Form */}
        <input type="email" placeholder="Enter your email" className="input-box" />
        <input type="password" placeholder="Create a password" className="input-box" />
        <input type="password" placeholder="Confirm your password" className="input-box" />
